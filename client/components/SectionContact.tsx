                    ...
                    >
                        ...
                        <div className='flex w-full justify-around'>
                            <div className='w-1/3 flex justify-center items-center relative'>
                                ...
                                />
                                {
                                    errors.title && (<p className="text-red-700 absolute top-full">{errors.title}</p>)
                                }
                            </div>
                            <div className='w-1/3 flex justify-center items-center relative'>
                                ...
                                />
                                {
                                    errors.company && (<p className="text-red-700 absolute top-full">{errors.company}</p>)
                                }
                            </div>
                            <div className='w-1/3 flex justify-center items-center relative'>
                                ...
                                />
                                {
                                    errors.email && (<p className="text-red-700 absolute top-full">{errors.email}</p>)
                                }
                            </div>
                        </div>
                        <div className='w-2/3 flex flex-col justify-center items-center relative'>
                            ...
                            />
                            {
                                errors.body && (<p className="text-red-700 absolute top-1/2">{errors.body}</p>)
                            }
                        </div>
                        <button
                            type='submit'
