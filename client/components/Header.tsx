    ...
    return (
        ...
        >
            ...
            <button onClick={(e) => handleDarkMode(e)} className='bg-blackPrimary border-double border border-white py-1 px-3 shadow-lg hover:shadow-sm hover:scale-110 transition-all shadow-black rounded-lg dark:bg-white dark:border-black'>
                <svg aria-hidden="true" id="theme-toggle-dark-icon" className="w-5 h-5 hidden fill-black" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z">
                    </path>
                </svg>
                <svg aria-hidden="true" id="theme-toggle-light-icon" className="w-5 h-5 fill-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
