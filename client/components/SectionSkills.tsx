...
const SectionSkills: React.FC<Props> = ({ allSkills, allTools, allSofts }) => {
    ...
    return (
        <div id='sectionSkills' className='text-white w-full flex flex-col justify-around text-4xl text-center relative z-20 dark:text-black'>
            ...
            <div className='flex flex-col w-full items-center justify-center top-full my-12 bg-blackSecundary dark:bg-slate-200 shadow-black shadow-2xl'>
