...
function PhotoAnime(contact: Contact) {
  return (
    <div className='flex flex-col justify-center items-center'>
      <div className='h-[25rem] rounded-full w-[25rem] flex flex-col opacity-0 flex-wrap staggering-grid-demo'>
        <Image
          src={photo.a0}
          height={40}
          width={40}
        ...
        <Image
          ...
          height={40}
          width={40}
          className="el absolute shadow-sm shadow-white dark:shadow-black"
        />
        <Image
          src={photo.a3}
          height={40}
